    ...
    <footer className="bg-gray-900 text-gray-300 py-10 px-10">
      <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-10">
        ...
        <div className="grid gap-2">
          ...
          <p>
            <a
              href="tel:+918874910202"
              className="text-sm hover:text-blue-400 hover:text-white"
            >
              📞 Designed by @Ashish
            </a>
          </p>
        ...
        <div className="grid gap-2">
          ...
          <p className="text-sm">
            Mau Road, Sidhari, Azamgarh, UP 276001
            <br />
            Phone:{" "}
            <a
              href="tel:+917905688034"
              className="text-blue-400 hover:text-white"
            >
              +91 7905688034
            </a>
          </p>
          <div className="flex space-x-4 mt-4 flex-wrap text-2xl">
